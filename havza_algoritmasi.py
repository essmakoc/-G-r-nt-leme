...
coin = cv2.imread("C:/Users/ASUS/.spyder-py3/Image processing/coins.jpg")
...
plt.figure(), plt.imshow(dist_tranform, cmap="gray"), plt.axis("off")

# resimi kucult yani nesneleri
ret, sure_foreground = cv2.threshold(dist_tranform, 0.4 * np.max(dist_tranform), 255, 0)
plt.figure(), plt.imshow(sure_foreground, cmap="gray"), plt.axis("off")

# arka plan için resimi buyut
