...
img = cv2.imread("C:/Users/ASUS/.spyder-py3/Image processing/red_blue.jpg")
...
golden_gate = cv2.imread("C:/Users/ASUS/.spyder-py3/Image processing/goldenGate.jpg")
...
img = cv2.imread("C:/Users/ASUS/.spyder-py3/Image processing/hist_equ.jpg", 0)
img_vis = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
